...
import { addEnergyBill, deleteEnergyBill, updateEnergyBill } from '@/lib/services/energy';
...
export const POST: APIRoute = async ({ request, redirect, locals, cookies }) => {
  ...
  if (mode === 'update') {
    ...
    return redirect(`/energy?year=${year}&saved=bill_updated`, 303);
  }
